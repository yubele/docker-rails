...
ENV RUBY_DOWNLOAD_URL_PREFIX="3.2"
...
WORKDIR "/tmp"
RUN curl https://cache.ruby-lang.org/pub/ruby/${RUBY_DOWNLOAD_URL_PREFIX}/ruby-${RUBY_VERSION}.tar.gz -o ruby.tar.gz
RUN [ $(sha256sum ruby.tar.gz | awk '{print $1}') = "${RUBY_SHA256}" ]
